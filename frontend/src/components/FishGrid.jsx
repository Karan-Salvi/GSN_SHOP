...
export default function FishGrid({ fish, loading }) {
  return (
    <section id="fish" data-testid="fish-section" className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 py-16 sm:py-24">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
        <div>
          ...
          <p className="mt-2 text-slate-600 max-w-2xl">
            प्रत्येक मासा ताज्या पकडलेल्या साठ्यातून. दर दररोज बाजारभावानुसार अपडेट होतो.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div data-testid="empty-fish-state" className="rounded-2xl border border-dashed border-slate-300 py-20 text-center text-slate-500">
